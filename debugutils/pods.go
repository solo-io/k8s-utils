...
//go:generate mockgen -destination mocks_test.go -self_package github.com/solo-io/k8s-utils/debugutils -package debugutils github.com/solo-io/k8s-utils/debugutils PodFinder,LogCollector,ResourceCollector,StorageClient
